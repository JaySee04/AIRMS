...
Counts: **9 models**, **138 columns**, **68 endpoints**, **25 pages**.
...
| DELETE | `/api/diag/deferred` | admin |  | backend/src/routes/diag.js |
| GET | `/api/diag/deferred` | admin |  | backend/src/routes/diag.js |
| GET | `/api/diag/skip-success` | admin |  | backend/src/routes/diag.js |
