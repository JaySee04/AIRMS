...
*Measured, not described. Every line below comes from calling all 66 endpoints as
...
**all 66 answered 401** except the four sign-in routes, which are unauthenticated
