...
const NAV: Record<'athlete' | 'medical' | 'admin', NavItem[]> = {
  ...
  medical: [
    { href: '/medical/dashboard',      label: 'Athlete Dashboard',  icon: <IconHome /> },
    { href: '/medical/injury-log',     label: 'Injury Logging',     icon: <IconClipboard /> },
    { href: '/medical/review-reports', label: 'Self-Report Review', icon: <IconCheckCircle /> },
    { href: '/medical/data-upload',    label: 'Data Uploading',     icon: <IconUpload /> },
  ],
  admin: [
